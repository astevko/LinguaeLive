...
// import ca.jhosek.linguaelive.domain.MemberDao;
 ...
 */
@ServiceName( value = "ca.jhosek.linguaelive.domain.MemberDao", locator = "ca.jhosek.linguaelive.domain.DaoServiceLocator" )
